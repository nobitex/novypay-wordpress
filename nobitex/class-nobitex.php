...
if (!class_exists('nobitex_abstract') && class_exists('WC_Payment_Gateway')) {

    abstract class nobitex_abstract extends WC_Payment_Gateway
    {
        ...
        public function init_form_fields()
        {
            ...
            $main = array(
                ...
                'btc' => array(
                    'title' => 'فعل سازی درگاه BTC',
                    'type' => 'checkbox',
                    'description' => 'کاربر میتواند با بیتکوین پرداخت کند.',
                    'default' => 'yes',
                    'desc_tip' => true,

                ),
                'ltc' => array(
                    'title' => 'فعل سازی درگاه LTC',
                    'type' => 'checkbox',
                    'description' => 'کاربر میتواند با لایتکوین پرداخت کند.',
                    'default' => 'no',
                    'desc_tip' => true,

                ),
                'xrp' => array(
                    'title' => 'فعل سازی درگاه XRP',
                    'type' => 'checkbox',
                    'description' => 'کاربر میتواند با ریپل پرداخت کند.',
                    'default' => 'no',
                    'desc_tip' => true,
